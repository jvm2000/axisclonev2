...
<template>
    ...
    <div class="mt-8 w-full h-auto rounded-lg bg-white">

        <div class="grid w-full">

            <div class="flex place-items-center py-4 pl-10 text-gray-400 border-b-2">
            ...
            <div 
                ...
                :key="index"
                class="flex place-items-center py-3 pl-10 border-b"
            >
                ...
                <div class="flex place-items-center w-[12rem]">
                    <div class="flex space-x-4 place-items-center">
                        <span class="w-2 h-2 rounded-full bg-[#EA5252]"></span>
                        <p>{{ students.status }}</p>
                    </div>
                </div>
                <div></div>
