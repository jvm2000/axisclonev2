...
<template>
    <div class="px-2">
        <div class="px-4 py-4 w-fit flex flex-col sm:flex-row space-y-1">
        ...
        <div class="place-items-center justify-center pt-2">
            <div class="h-[42rem] w-full sm:w-[78rem] bg-white rounded-xl">
                <div class="w-full">
                        ...
                        <div class="table w-full border-separate border-spacing-y-6 text-sm">
                            ...
                            <div class="table-row-group w-full">
                                <div 
                                    ...
                                    :key="index"
                                    :class="[leads.status == 'dead' ? 'block' : 'hidden']"
                                >
                                    <div 
                                    ...
                                    <div class="table-cell" v-if="leads.status == 'dead'">
                                        <p>{{ leads.mobileno }}</p>
                                    </div>
                                    <div class="table-cell" v-if="leads.status == 'dead'">15</div>
                                    <div class="hidden sm:table-cell" v-if="leads.status == 'dead'">
                                    ...
                                    <div class="hidden sm:table-cell" v-if="leads.status == 'dead'">Annie Leonheart</div>
                                    <div class="table-cell place-items-center" v-if="leads.status == 'dead'">
                    ...
                    <div class="flex place-items-center h-[4rem] w-full px-8" v-if="totalPage >= 1">
                        ...
                        <div class="w-[7rem] sm:w-[40rem]"></div>
