<script setup lang="ts">
    ...
    const { isDelClassArea, openClassAreaDel } = modalFunctions()
    ...
    const { locationObj, classDel } = addLocation()
...
<template>
    <TransitionRoot appear :show="isDelClassArea" as="template">
            ...
            >
              ...
              >
                ...
                <div class="text-2xl w-full py-2 pl-6 border-b-2 border-gray-100 flex space-x-4 place-items-center">
                    ...
                    <p>Delete Class Area</p>
                </div>
                <div class="pt-6 text-[16px] px-10 space-y-4 place-items-start pb-4">
                    <p>Are you sure you want to remove <b>{{ locationObj.name }}</b></p>
                    <p><span class="font-semibold">Warning! </span>When you delete this class area, all schedules<br> associtated with will be removed from the timetable</p>
                    <p>You must first edit the schedules and use a different class<br>
                    if you want to keep the schedule on the timetable<br>
                    currently assigned to this class area..</p>
                ...
                <div class="w-full relative pt-4">
                    <div class="flex absolute right-8 text-white space-x-4 text-[16px]">
                        ...
                        <button 
                            ...
                            @click="clearInput(),openClassAreaDel()"
                        >
                            Delete
                    </button>
                    </div>
