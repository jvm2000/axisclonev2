<script setup lang="ts">
    ...
    const { dayPatterns, form, daySelected, selectD, isSelected, dayObjected, dayO, getStyle } = addClassTable()
                        ...
                        <div class="grid place-items-center ">
                          <div class="flex space-x-4 py-4 z-[20]">
                            <div 
                                ...
                                :style="getStyle(days)"
                                @click="dayO(days),isSelected(true), selectD('true')"
                            >
                                {{ days.d }}
                            </div>
                          </div>
                    ...
                    <div class="flex space-x-8 w-full">
                        <div class="flex flex-col space-y-3">
                            ...
                            <p 
                              ...
                              :class="[form.limitS ? 'block' : 'hidden']"
                            >
                              No Limit
                            </p>
                            <input 
                                ...
                                class="w-[14.5rem] border border-gray-400 py-3 px-4 rounded-lg text-gray-500"
                                :class="[form.limitS == '' ? 'block' : 'hidden']"
                                v-model="form.classLimitS"
                            >
                            <div class="flex space-x-2 place-items-center">
                              <input v-model="form.limitS" type="checkbox" class="ml-1 w-4 h-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <p 
                              class="w-[14.5rem] border border-gray-400 py-3 px-4 rounded-lg text-gray-500 bg-[#E9F0FA]"
                              :class="[form.limitL ? 'block' : 'hidden']"
                            >
                              No Limit
                            </p>
                            <input 
                                ...
                                class="w-[14.5rem] border border-gray-400 py-3 px-4 rounded-lg text-gray-500"
                                :class="[form.limitL == '' ? 'block' : 'hidden']"
                                v-model="form.classLimitL"
                            >
                            <div class="flex space-x-2 place-items-center">
                              <input v-model="form.limitL" type="checkbox" class="ml-1 w-4 h-4">
                              <p class="text-sm">No Limit</p>
                            </div>
                        </div>
                    </div>
