...
const { isConfirmInactiveModal } = modalFunctions()
const { leadViewItem } = useViewProfile()
</script>

<template>
    <TransitionRoot appear :show="isConfirmInactiveModal" as="template">
              ...
              >
                ...
                <div class="px-10">
                  <div class="flex flex-col w-full pb-4">
                    ...
                    <p class="text-[24px] text-center">is now <b>inactive</b></p>
                  </div>
                </div>
              </DialogPanel>
            </TransitionChild>
