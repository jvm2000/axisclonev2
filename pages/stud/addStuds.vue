            ...
            <div class="z-[0] w-full sm:z-[10]">
                ...
                <div class="px-20">
                    ...
                    <div class="px-[13rem] py-10 place-items-center">
                        <div class="w-[64rem] min-h-[100rem] bg-white rounded-xl px-8 py-4">
                            <div class="overflow-y-scroll h-[50rem]">
                                <div class="flex flex-row place-items-center">
                                    <p class="text-[24px] text-blue-400 font-semibold">Add Student</p>
                                    <div class="w-[44rem]"></div>
                                ...
                                <div class="flex pt-12">
                                    <div class="space-y-6">
                                        ...
                                        <div class="flex flex-row place-items-center space-x-[5.7rem]">
                                            <p class="text-[16px]">stud ID</p>
                                            <input type="text" class="text-[16px] border-2 border-gray-400 pl-6 w-[24rem] h-[3rem] rounded-lg" placeholder="Enter Student ID"
                                                v-model="form.studID"
                                            >
                                        </div>
                                ...
                                <div class="flex pt-12">
                                    <div class="space-y-6">
                                        ...
                                        <div class="pb-10">
                                            <div v-if="form.studCondition" class="w-[44rem] h-[20rem] block bg-[#F9FCFD] px-8 py-4 space-y-6">
                                                <div class="space-y-4">
